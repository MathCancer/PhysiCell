...
% \left( \frac{ (1-\vec{c}_2) \grvec{\rho}_k + \vec{c}_1} }{ \vec{c}_2 } \right),
\eeq
If you set \v|default_microenvironment_options.track_internalized_substrates_in_each_agent = true|, then 
...
this structure tracks internalized total substrates (See Section \ref{sec:BioFVM_internalization_tracking}) in the cell after secretion and 
...
uptake). The main data elements include:
