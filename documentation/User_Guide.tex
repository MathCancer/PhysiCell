...
\newcommand{\ReleaseDate}{January 26, 2020} 
...
\begin{enumerate}
\item 
\v|diffusion_dt| is the step size used in the diffusion solver, including the secretion and uptake processes. 
...
Users should use v|Cell::start_death(int)| instead. See Section \ref{sec:cell_member_functions}.} 
