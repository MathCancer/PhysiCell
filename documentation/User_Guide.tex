...
\subsubsection{Specifying the microenvironment via XML *preferred method*}
\label{sec:BioFVM_setup_XML}
As of PhysiCell version 1.6.0, the chemical microenvironment can be completely 
set up via the XML configuration file. (See also Section \ref{sec:sec:XML_PhysiCell_structure} to 
...
and initial conditions. All these properties can be manually edited within a PhysiCell 
...
As of Version 1.6.0, PhysiCell can fully define the chemical microenvironment by simple 
modifications to the XML configuration file. 
(See Sec \ref{?} to learn more about the BioFVM chemical microenvironment.) 
...
Notice that the end of the \verb+microenvironment_setup+ block sets additional options: 
